...
function StatCard({ icon: Icon, value, label }) {
  return (
    <div className="glass rounded-2xl p-4 text-center transition-all duration-300 ease-in-out hover:scale-[1.03] hover:border-purple-300/80 hover:shadow-[0_0_26px_rgba(168,85,247,0.55),0_0_14px_rgba(59,130,246,0.4)]">
    ...
    <div className="min-h-screen bg-base-100 text-base-content overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto space-y-6 py-10 px-4">
        ...
        <motion.div
          ...
          className="glass rounded-3xl overflow-hidden transition-all duration-300 ease-in-out hover:scale-[1.01] hover:border-purple-300/80 hover:shadow-[0_0_26px_rgba(168,85,247,0.55),0_0_14px_rgba(59,130,246,0.4)]"
        >
          {/* Banner */}
        ...
        {/* ───── TABS ───── */}
        <div className="glass rounded-3xl p-4 transition-all duration-300 ease-in-out hover:border-purple-300/80 hover:shadow-[0_0_26px_rgba(168,85,247,0.55),0_0_14px_rgba(59,130,246,0.4)]">
          {/* Tab buttons */}
            ...
            {["skills", "reviews"].map((t) => (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-sm transition ${
                  tab === t ? "bg-primary text-white" : "hover:bg-base-200"
                }`}
              >
                {t.toUpperCase()}
              </button>
          ...
          <AnimatePresence mode="wait">
            ...
            {tab === "skills" && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className="space-y-6 font-[Inter,system-ui,sans-serif]"
              >
                <div>
                  <p className="mb-2 text-[0.7rem] font-bold uppercase tracking-[0.2em] text-slate-400">
                    CAN TEACH
                  </p>
            ...
            {tab === "reviews" && (
              ...
              >
                {reviews.map((r) => (
                  <div
                    key={r.id}
                    className="p-4 rounded-2xl bg-base-200/50 hover:bg-base-200 transition-all duration-300 ease-in-out hover:scale-[1.01] hover:border-purple-300/80 hover:shadow-[0_0_26px_rgba(168,85,247,0.55),0_0_14px_rgba(59,130,246,0.4)] border border-transparent"
                  >
